...
public class Usuario implements UserDetails {
    ...
    @NotNull
    @Pattern(regexp = "^(?=.*[a-zA-Z])[a-zA-Z\s]{3,}$", message = "Usuario deve conter no mínimo 3 caracteres e nenhum pode ser numérico")
    ...
    public boolean setUsuario(String novoUsuario) {
    ...
    private boolean validarUsuario(String usuario)
    {
        ...
        return padrao.matcher(usuario).matches();
    }
